...
const project_descriptions = ["I'm currently working on a team to designing and develop a full-stack administrative web application with TypeScript and Vue.js to allow customer service agents to manage their resources, and to facilitate interactions between agents and backend microservice APIs.",
  ...
  "As a memeber of the Embodied and Immersive Technologies Lab, I work with PhD students and Professor Lindgren to better understand how to apply educational theories to the design of educational technologies. I am currently in the early process of understanding how to use gestures and virtual reality to improve statistical intuition within students.",
  ...
  "As a research project, I developed a rule-based natural language processing algorithm to convert English to ASL and converted grammatical patterns using spaCy. I also webscraped 100+ ASL videos from online ASL datasets, stored data in a mySQL database, and developed an Android app to make requests to Flask server.",
  ...
  "I was a full-stack mobile developer on the application Ethikal, where users had the option to input clothing items of their choice to receive alternative clothes from ethical clothing brands. I web-scraped numerous clothing items from ethical brands online and trained an image classification model to group the into categories for the image search. Our team recieved the semifinalistaward int he Technovation competition as a result."]
